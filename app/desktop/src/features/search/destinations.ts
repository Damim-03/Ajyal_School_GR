...
const STANDALONE: Destination[] = [
  ...
  {
    id: "screen:students-import",
    kind: "screen",
    title: "استيراد الطلبة من Excel",
    detail: "إدخالُ قائمةِ طلبةٍ دفعةً واحدة",
    to: PATHS.studentsImport,
    moduleId: "students",
    keywords: ["اكسل", "excel", "استيراد", "دفعة", "ملف", "جماعي"],
  },
  {
    id: "screen:teachers-import",
    kind: "screen",
    title: "استيراد الأساتذة من Excel",
    detail: "إدخالُ قائمةِ أساتذةٍ دفعةً واحدة",
