...
router.post("/:id/documents", (0, permission_middleware_1.requirePermission)("settlement.document"), (0, validate_middleware_1.validateParams)(settlement_schema_1.settlementIdSchema), (0, validate_middleware_1.validate)(settlement_schema_1.attachDocumentSchema), (0, async_handler_middleware_1.asyncHandler)(settlement_controller_1.attachSettlementDocumentController));
router.delete("/documents/:documentId", (0, permission_middleware_1.requirePermission)("settlement.document"), (0, validate_middleware_1.validateParams)(settlement_schema_1.documentIdSchema), (0, async_handler_middleware_1.asyncHandler)(settlement_controller_1.removeSettlementDocumentController));
