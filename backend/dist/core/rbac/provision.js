...
exports.provisionRbac = exports.seedRoles = exports.seedPermissions = exports.ROLES = exports.ADMIN_ROLE = exports.buildPermissions = void 0;
...
// 3. التركيب
// --------------------------------------------------
const seedPermissions = async (log = false) => {
    const permissions = (0, exports.buildPermissions)();
...
const seedRoles = async (allPermissions, log = false) => {
    const roleIds = new Map();
    for (const definition of exports.ROLES) {
 ...
 */
const provisionRbac = async (log = false) => {
    const permissions = await (0, exports.seedPermissions)(log);
    const roleIds = await (0, exports.seedRoles)(permissions, log);
    const adminRoleId = roleIds.get(exports.ADMIN_ROLE);
    if (!adminRoleId) {
        throw new Error(`${exports.ADMIN_ROLE} role was not created`);
    }
    return adminRoleId;
};
exports.provisionRbac = provisionRbac;
